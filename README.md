...
-   [Configuring your mission](#cfgmission)
    -   [description.ext](#descext)
    -   [ADF\_init\_config.sqf](#initcfg)
-   [Advanced Editing](#sod)
-   [Legal](#legal)
...
With Notepad++ open ADF\_init\_config.sqf which can be found in the mission root folder. This is your main mission configuration. Basically everything, from loadout to radio/call sign presets can be configured here. **If you are not sure if you need to change a value then best leave it as is**. Make sure to test your mission in between changes, else you might loose track of your mission development process.
