...
{
	{[_x,_DAC_This_Zone]execVM "Core\TP\DAC\Scripts\DAC_New_Groups.sqf"} foreach _ScriptArray;
	_run = 1;
}
else
{
...
while {_run > 0} do
{
	switch (_run) do
	{
		...
		case 4:		{
						...
						{
							case 1:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],1,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]execVM "Core\TP\DAC\Scripts\DAC_Group_Soldier.sqf";
										[1,[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],1,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]]execVM "Core\TP\DAC\Scripts\DAC_Rebuild_Group.sqf";
									};
							case 2:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],2,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]execVM "Core\TP\DAC\Scripts\DAC_Group_Vehicle.sqf";
										[2,[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],2,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]]execVM "Core\TP\DAC\Scripts\DAC_Rebuild_Group.sqf";
									};
							case 3:	{
										[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],3,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,_DAC_ExtraUnit,_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]execVM "Core\TP\DAC\Scripts\DAC_Group_Tank.sqf";
										[3,[_countrandom,[_GroupWP,_GroupPos,_zData,_mr],3,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_maxrad,_DAC_ExtraUnit,_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,"null",[_countmax,_countmin,_DAC_ZoneRadiusX,_DAC_ZoneRadiusY,_DAC_Zone_Set,_wpConfNr]]]execVM "Core\TP\DAC\Scripts\DAC_Rebuild_Group.sqf";
									};
							case 4:	{
										if((random 100) < _mz) then {_mr = 0} else {_mr = 1};
										[_countrandom,1,[_GroupWP,_GroupPos,_zData,_mr],4,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_DAC_Zone_Set,_wpConfNr]execVM "Core\TP\DAC\Scripts\DAC_Group_Air.sqf";
										[4,[_countrandom,1,[_GroupWP,_GroupPos,_zData,_mr],4,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_DAC_Zone_Set,_wpConfNr]]execVM "Core\TP\DAC\Scripts\DAC_Rebuild_Group.sqf";
									};
							case 5:	{
										[_countrandom,1,_GroupWP,5,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_Camp_Pool,_DAC_Zone_Set,_wpConfNr]execVM "Core\TP\DAC\Scripts\DAC_Group_Camp.sqf";
										[5,[_countrandom,1,_GroupWP,5,_DAC_ZoneSide,_DAC_ZoneStart,_DAC_ZoneEnde,_cwp,_HeloArray,[],_GroupVar,_m,_DAC_This_Zone,_DAC_UnitTyp,_Camp_Pool,_DAC_Zone_Set,_wpConfNr]]execVM "Core\TP\DAC\Scripts\DAC_Rebuild_Group.sqf";
									};
							Default {};
						};
						_zc = _zc + 1;
