...
// DAC Arrays & Vars;
	...
	DAC_Master_Init = 0;DAC_WPCount_Init = 0;DAC_AI_Path = format["Core\TP\DAC\AI_%1\",DAC_AI_AddOn];DAC_NewZone = 0;
...
{
	sleep 2;
	[1]execVM "Core\TP\DAC\Scripts\DAC_Init_Waypoint.sqf";
};
...
[]execVM "Core\TP\DAC\Scripts\DAC_Clean_Arrays.sqf";